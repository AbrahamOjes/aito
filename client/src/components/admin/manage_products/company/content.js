...
const Content = ({ setAlert }) => {
  ...
  if (modalIsOpen) {
    modal = (
      <Modal closeModal={closeModalHandler} updatecompanies={updatecompanies} />
    );
  }
  return (
    <Fragment>
      <div className="w-full h-screen mx-0 lg:mx-2 mt-16">
        ...
        <div className="content-header w-full px-4 py-2 flex justify-between">
          <h1 className="text-lg font-bold text-gray-700">Product Companies</h1>
          <div>
            <button
